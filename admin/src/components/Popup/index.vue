        ...
        >
            ...
            <template #footer>
                <div class="dialog-footer">
                    <el-button v-if="actualCancelText" @click="handleEvent('cancel')">
                        {{ actualCancelText }}
                    </el-button>
                    <el-button
                        v-if="actualConfirmText"
                        type="primary"
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const actualConfirmText = computed(() => {
            if (props.confirmButtonText === false) return ''
            return props.confirmButtonText || t('common.confirm')
        })
        const actualCancelText = computed(() => {
            if (props.cancelButtonText === false) return ''
