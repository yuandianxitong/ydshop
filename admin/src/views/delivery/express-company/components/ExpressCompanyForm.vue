  ...
  >
    ...
    >
      ...
      <el-form-item label="编码" prop="code">
        <el-input v-model="form.code" placeholder="如 SF、ZTO、YTO" />
      </el-form-item>
...
<script setup lang="ts" name="ExpressCompanyForm">
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (isEdit.value && props.formData.id) {
      await expressCompanyApi.update(props.formData.id, { ...form })
      ElMessage.success('编辑成功')
    } else {
      await expressCompanyApi.create({ ...form })
