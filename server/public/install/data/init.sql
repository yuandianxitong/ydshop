...
INSERT INTO `permissions` (`id`, `name`, `title`, `group`, `description`, `guard_name`, `status`, `sort`, `created_at`, `updated_at`) VALUES
    ...
    (1822, 'plugin.build',     '插件管理-云编译', '插件管理', '查看后台/PC 云编译任务', 'admin', 1, 1822, NOW(), NOW()),
    (1823, 'plugin.build.rebuild', '插件管理-重建前端', '插件管理', '手动重建 admin/PC', 'admin', 1, 1823, NOW(), NOW()),
    (1824, 'mobile.build',     '插件管理-客户端发布', '插件管理', '查看 H5/小程序编译', 'admin', 1, 1824, NOW(), NOW()),
    (1825, 'mobile.build.upload', '插件管理-上传小程序', '插件管理', 'miniprogram-ci 上传开发版', 'admin', 1, 1825, NOW(), NOW()),
    -- ============================================================
    -- 商品中心权限
    -- ============================================================
...
('pc_header_menu', '[{"label":"首页","path":"/"},{"label":"热销榜单","path":"/goods?sort=sales"},{"label":"新品推荐","path":"/goods?sort=newest"},{"label":"好物优选","path":"/goods?is_recommend=1"},{"label":"商城资讯","path":"/article"},{"label":"帮助中心","path":"/help"}]', 'diy', 'json', 'PC 头部导航菜单', 'PC 商城头部导航默认配置', NULL, NULL, 4, 1, NOW(), NOW()),
...
(1, 'home', 'uniapp', '移动端首页', '[{"id":"comp_1","type":"search-bar","props":{"placeholder":"搜索商品","border_radius":20,"bg_color":"#f5f5f5"}},{"id":"comp_2","type":"banner","props":{"items":[{"image":"/storage/diy-defaults/home/banner/01.jpg","url":"","title":""},{"image":"/storage/diy-defaults/home/banner/02.jpg","url":"","title":""},{"image":"/storage/diy-defaults/home/banner/03.jpg","url":"","title":""}],"autoplay":true,"interval":3000,"height":360}},{"id":"comp_3","type":"category-nav","props":{"style":"icon-grid","rows":2,"columns":5,"items":[{"icon":"/storage/diy-defaults/home/category/01.png","title":"商品列表","link":"/modules/goods/pages/list"},{"icon":"/storage/diy-defaults/home/category/02.png","title":"热销榜单","link":"/modules/goods/pages/list?sort=sales"},{"icon":"/storage/diy-defaults/home/category/03.png","title":"商品分类","link":"/pages/category/index"},{"icon":"/storage/diy-defaults/home/category/04.png","title":"个人中心","link":"/pages/my/index"},{"icon":"/storage/diy-defaults/home/category/05.png","title":"浏览记录","link":"/modules/user/pages/history"},{"icon":"/storage/diy-defaults/home/category/06.png","title":"购物车","link":"/pages/cart/index"},{"icon":"/storage/diy-defaults/home/category/07.png","title":"我的收藏","link":"/modules/favorite/pages/list"},{"icon":"/storage/diy-defaults/home/category/08.png","title":"帮助中心","link":"/modules/help/pages/list"},{"icon":"/storage/diy-defaults/home/category/09.png","title":"我的订单","link":"/modules/order/pages/list"},{"icon":"/storage/diy-defaults/home/category/10.png","title":"新品推荐","link":"/modules/goods/pages/list?sort=newest"}]}},{"id":"comp_6","type":"image-cube","props":{"rows":2,"cols":2,"gap":8,"borderRadius":4,"items":[{"image":"/storage/diy-defaults/home/cube/01.png","link":"","rowStart":1,"colStart":1,"rowSpan":1,"colSpan":1},{"image":"/storage/diy-defaults/home/cube/02.png","link":"","rowStart":1,"colStart":2,"rowSpan":1,"colSpan":1},{"image":"/storage/diy-defaults/home/cube/03.png","link":"","rowStart":2,"colStart":1,"rowSpan":1,"colSpan":1},{"image":"/storage/diy-defaults/home/cube/04.png","link":"","rowStart":2,"colStart":2,"rowSpan":1,"colSpan":1}]}},{"id":"comp_7","type":"title-bar","props":{"title":"热销推荐","subtitle":"","align":"left","more_url":"/pages/goods/list","more_text":"查看更多"}},{"id":"comp_8","type":"goods-grid","props":{"title":"","source":"tag","goods_ids":[],"category_id":null,"tag":"hot","limit":10,"columns":2}}]', 1, 1, 0, 1, NOW(), NOW()),
